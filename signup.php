...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (registerUser($email, $password)) {
        loginUser($email);
...
<head>
    ...
    <style>
        ...
        @media (max-width: 900px) {
            ...
            .signup-card { flex-direction: column; min-height: unset; }
            .illustration-section { display: none; }
            .signup-form-section { padding: 32px 16px; min-height: unset; }
        }
        @media (max-width: 600px) {
            .signup-title { font-size: 1.5rem; }
            .signup-card { border-radius: 1.2rem; }
    ...
    <div class="signup-card">
        <div class="signup-form-section">
            ...
            <form method="post" autocomplete="off">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" placeholder="email@gmail.com" required autofocus>
                </div>
        ...
        <div class="illustration-section">
            ...
            <div class="illustration">
                <img src="photos/287de5cc1c825597a50d56520555ee32-removebg-preview.png" alt="Signup Illustration" />
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.signup-btn, .social').forEach(el => {
